...
@section('page')
    <form action="{{ url('admin/staff/payment') }}" method="POST">
        @csrf
        <div class="row">
                ...
                <div class="card radius-15 border-lg-top-primary">
                    <div class="card-body p-5">
                        <div class="card-title">
                                ...
                                <h4 class="mb-0 text-primary">Create Staff Payment</h4>
                                <a href="{{url('admin/staff/payment')}}" class="btn btn-primary mb-2 btn-sm float-right">View all</a>
